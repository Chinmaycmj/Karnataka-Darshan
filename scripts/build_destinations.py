...
destinations = [
  # --- BAGALKOTE ---
  {
    ...
    "category": "Heritage",
    "subCategories": ["Cave Temples", "Rock Cut Architecture", "Chalukya"],
    ...
    "tags": ["Cave", "Heritage", "Rock Architecture", "Agastya Lake"],
    "isFeatured": True
  },
  {
    ...
    "region": "North Karnataka",
    "category": "Heritage",
    "subCategories": ["UNESCO World Heritage", "Temples", "Chalukya"],
    ...
    "tags": ["UNESCO", "Heritage", "Temples", "Architecture"],
    "isFeatured": True
  },
  {
    "id": "aihole-complex",
    ...
    "region": "North Karnataka",
    "category": "Heritage",
    "subCategories": ["Ancient Temples", "Chalukya", "Archaeology"],
    ...
    "bestTime": "October to March",
    "tags": ["Temples", "Architecture", "Durga Temple", "Heritage"]
  },
  ...
  # --- BALLARI ---
  {
    ...
    "category": "Heritage",
    "subCategories": ["Forts", "Monolith", "Historical"],
    ...
    "tags": ["Fort", "Trek", "Granite", "History"]
  },
  ...
  # --- BENGALURU RURAL ---
  {
    ...
    "region": "Bengaluru",
    "category": "Heritage",
    "subCategories": ["Stone Fort", "Tipu Sultan", "Monuments"],
    ...
    "tags": ["Fort", "Tipu Sultan", "Heritage"]
  },
  {
    "id": "ghati-subramanya",
    ...
    "region": "Bengaluru",
    "category": "Spiritual",
    "subCategories": ["Snake Deity", "Pilgrimage", "Dravidian"],
    ...
    "bestTime": "All Year Round",
    "tags": ["Spiritual", "Pilgrimage", "Snake Shrine"]
  },
  ...
  # --- BENGALURU URBAN ---
  {
    ...
    "region": "Bengaluru",
    "category": "Heritage",
    "subCategories": ["Royal Palace", "Tudor Architecture", "Wadiyar"],
  ...
  },
  {
    ...
    "region": "Bengaluru",
    "category": "Nature",
    "subCategories": ["Botanical Park", "Glass House", "Historic Garden"],
    ...
    "bestTime": "All Year Round",
    "tags": ["Botanical", "Nature", "Glass House"],
    "isFeatured": True
  },
  ...
  # --- BELAGAVI ---
  {
    ...
    "region": "North Karnataka",
    "category": "Heritage",
    "subCategories": ["Ancient Fort", "Jain Temple", "Ratta Dynasty"],
  ...
  },
  {
    ...
    "region": "North Karnataka",
    "category": "Nature",
    "subCategories": ["Waterfall", "Suspension Bridge", "Ghataprabha"],
    ...
    "tags": ["Waterfall", "Suspension Bridge", "Nature"],
    "isFeatured": True
  },
  ...
  # --- BIDAR ---
  {
    ...
    "region": "Kalyana Karnataka",
    "category": "Heritage",
    "subCategories": ["Bahmani Fort", "Persian Architecture", "Royal Palace"],
    ...
    "bestTime": "October to March",
    "tags": ["Bahmani", "Fort", "Rangeen Mahal"],
    "isFeatured": True
  },
  {
    ...
    "region": "Kalyana Karnataka",
    "category": "Spiritual",
    "subCategories": ["Sikh Shrine", "Sacred Spring", "Pilgrimage"],
    ...
    "bestTime": "All Year Round",
    "tags": ["Gurudwara", "Spiritual", "Spring"]
  },
  ...
  # --- CHAMARAJANAGAR ---
  {
    ...
    "category": "Wildlife",
    "subCategories": ["Tiger Reserve", "Jungle Safari", "Nilgiri Biosphere"],
    ...
    "tags": ["Tigers", "Elephants", "Safari", "Wildlife"],
    "isFeatured": True
  },
  ...
  # --- CHIKKABALLAPUR ---
  {
    ...
    "region": "Bengaluru",
    "category": "Hills",
    "subCategories": ["Cloud Inversion", "Hill Station", "Sunrise"],
    ...
    "tags": ["Sunrise", "Clouds", "Hill Station"],
    "isFeatured": True
  },
  {
    ...
    "region": "Bengaluru",
    "category": "Heritage",
    "subCategories": ["Dravidian Architecture", "Nolamba", "Stepwell"],
...
destinations.extend([
  # --- CHIKKAMAGALURU ---
  {
    ...
    "region": "Malnad",
    "category": "Hills",
    "subCategories": ["Highest Peak", "Trekking", "Western Ghats"],
    ...
    "tags": ["Peak", "Trek", "Highest", "Western Ghats"],
    "isFeatured": True
  },
  {
    "id": "baba-budangiri",
    ...
    "region": "Malnad",
    "category": "Hills",
    "subCategories": ["Coffee Origin", "Syncretic Shrine", "Cliffs"],
  ...
  # --- CHITRADURGA ---
  {
    ...
    "category": "Heritage",
    "subCategories": ["Impregnable Fort", "Seven Walls", "Onake Obavva"],
    ...
    "timings": "6:00 AM - 6:00 PM",
    "bestTime": "October to February",
    "tags": ["Fort", "Seven Walls", "Obavva", "Heritage"],
    "isFeatured": True
  },
  ...
  # --- DAKSHINA KANNADA ---
  {
    ...
    "category": "Coast",
    "subCategories": ["Golden Sands", "Water Sports", "Sunset"],
    ...
    "timings": "Open 24 Hours",
    "bestTime": "October to March",
    "tags": ["Beach", "Coast", "Kite Festival", "Water Sports"]
  },
  {
    ...
    "region": "Coastal Karnataka",
    "category": "Heritage",
    "subCategories": ["Jain Basadi", "Vijayanagara Style", "Carved Pillars"],
    ...
    "timings": "6:00 AM - 7:00 PM",
    "bestTime": "October to March",
    "tags": ["Jain", "1000 Pillars", "Basadi", "Heritage"],
    "isFeatured": True
  },
  ...
  # --- DAVANAGERE ---
  {
    ...
    "region": "Central Karnataka",
    "category": "Heritage",
    "subCategories": ["Stepped Tank", "Indo-Saracenic", "Palegar"],
    ...
    "timings": "8:00 AM - 6:00 PM",
    "bestTime": "October to March",
    "tags": ["Stepwell", "Pushkarini", "Heritage"],
    "isFeatured": True
  },
  ...
  # --- DHARWAD ---
  {
    ...
    "region": "North Karnataka",
    "category": "Heritage",
    "subCategories": ["Western Chalukya", "Black Stone", "11th Century"],
    ...
    "timings": "6:00 AM - 6:00 PM",
    "bestTime": "October to March",
    "tags": ["Chalukya", "Black Granite", "Temple"]
  },
  ...
  # --- GADAG ---
  {
    ...
    "region": "North Karnataka",
    "category": "Heritage",
    "subCategories": ["Kalyana Chalukya", "Stepped Wells", "Kalyanis"],
    ...
    "bestTime": "October to February",
    "tags": ["Stepwells", "Chalukya", "Lakkundi"],
    "isFeatured": True
  },
  ...
  # --- HASSAN ---
  {
    ...
    "region": "Malnad",
    "category": "Heritage",
    "subCategories": ["UNESCO World Heritage", "Hoysala", "Soapstone Carving"],
    ...
    "bestTime": "October to March",
    "tags": ["UNESCO", "Hoysala", "Belur", "Madanika"],
    "isFeatured": True
  },
  {
    ...
    "region": "Malnad",
    "category": "Heritage",
    "subCategories": ["UNESCO World Heritage", "Twin Temple", "Friezes"],
  ...
  },
  {
    ...
    "region": "Malnad",
    "category": "Spiritual",
    "subCategories": ["Monolith Statue", "Jain Tirthankara", "Vindhyagiri"],
    ...
    "timings": "6:00 AM - 6:30 PM",
    "bestTime": "October to March",
    "tags": ["Monolith", "Gommateshwara", "Jain", "Heritage"],
    "isFeatured": True
  },
  {
    ...
    "region": "Malnad",
    "category": "Heritage",
    "subCategories": ["Gothic Ruins", "Hemavathi Reservoir", "Photography"],
    ...
    "tags": ["Church", "Gothic", "Submerged", "Photography"]
  },
  ...
  # --- HAVERI ---
  {
    ...
    "region": "Central Karnataka",
    "category": "Wildlife",
    "subCategories": ["Blackbuck", "Great Indian Bustard", "Grassland"],
    ...
    "timings": "6:00 AM - 6:00 PM",
    "bestTime": "October to March",
    "tags": ["Blackbuck", "Sanctuary", "Wildlife"]
  }
])
...
destinations.extend([
  # --- KALABURAGI ---
  {
    ...
    "region": "Kalyana Karnataka",
    "category": "Heritage",
    "subCategories": ["Bahmani Fort", "Covered Mosque", "Spanish Cordoba Style"],
    ...
    "timings": "9:00 AM - 5:30 PM",
    "bestTime": "October to February",
    "tags": ["Fort", "Bahmani", "Masjid", "Heritage"],
    "isFeatured": True
  },
  {
    ...
    "region": "Kalyana Karnataka",
    "category": "Spiritual",
    "subCategories": ["Sufi Dargah", "Chishti Order", "Pilgrimage"],
    ...
    "timings": "Open 24 Hours",
    "bestTime": "All Year Round",
    "tags": ["Sufi", "Dargah", "Chishti", "Spiritual"]
  },
  ...
  # --- KODAGU ---
  {
    ...
    "region": "Malnad",
    "category": "Nature",
    "subCategories": ["Waterfall", "Coffee Plantation", "Western Ghats"],
    ...
    "tags": ["Waterfall", "Coorg", "Coffee", "Nature"],
    "isFeatured": True
  },
  {
    ...
    "region": "Malnad",
    "category": "Spiritual",
    "subCategories": ["River Origin", "Brahmagiri Hills", "Sacred Tank"],
    ...
    "timings": "6:00 AM - 6:30 PM",
    "bestTime": "October to March",
    "tags": ["Cauvery", "Origin", "Pilgrimage", "Brahmagiri"]
  },
  {
    ...
    "region": "Malnad",
    "category": "Wildlife",
    "subCategories": ["Elephant Care", "River Cauvery", "River Rafting"],
    ...
    "bestTime": "September to March",
    "tags": ["Elephants", "Cauvery", "Wildlife", "Coorg"],
    "isFeatured": True
  },
  ...
  # --- KOLAR ---
  {
    ...
    "region": "Bengaluru",
    "category": "Spiritual",
    "subCategories": ["Crore Shiva Lingas", "108ft Linga", "Nandi Statue"],
    ...
    "bestTime": "October to March",
    "tags": ["Linga", "Shiva", "Crore Lingas", "Spiritual"],
    "isFeatured": True
  },
  ...
  # --- KOPPAL ---
  {
    ...
    "region": "Kalyana Karnataka",
    "category": "Heritage",
    "subCategories": ["Devalaya Chakravarti", "Kalyana Chalukya", "Soapstone"],
    ...
    "timings": "6:00 AM - 6:00 PM",
    "bestTime": "October to March",
    "tags": ["Chalukya", "Itagi", "Emperor of Temples", "Heritage"],
    "isFeatured": True
  },
  ...
  # --- MANDYA ---
  {
    ...
    "region": "South Karnataka",
    "category": "Nature",
    "subCategories": ["Twin Waterfall", "River Cauvery", "First Hydroelectric"],
    ...
    "bestTime": "July to October",
    "tags": ["Waterfalls", "Cauvery", "Shivanasamudra", "Nature"],
    "isFeatured": True
  },
  {
    ...
    "region": "South Karnataka",
    "category": "Wildlife",
    "subCategories": ["Islets Sanctuary", "Boat Safari", "Painted Storks"],
    ...
    "tags": ["Birds", "Boat Safari", "Crocodiles", "Cauvery"],
    "isFeatured": True
  },
  ...
  # --- MYSURU ---
  {
    ...
    "region": "South Karnataka",
    "category": "Heritage",
    "subCategories": ["Indo-Saracenic Palace", "Wadiyar Dynasty", "Illumination"],
    ...
    "tags": ["Palace", "Wadiyar", "Royal", "Illumination", "Dasara"],
    "isFeatured": True
  },
  {
    ...
    "region": "South Karnataka",
    "category": "Heritage",
    "subCategories": ["UNESCO World Heritage", "Hoysala Trikuta", "Stellate Plan"],
    ...
    "timings": "8:30 AM - 5:30 PM",
    "bestTime": "October to March",
    "tags": ["UNESCO", "Hoysala", "Somanathapura", "Keshava"],
    "isFeatured": True
  },
  ...
  # --- RAMANAGARA ---
  {
    ...
    "region": "Bengaluru",
    "category": "Adventure",
    "subCategories": ["Granite Monolith", "Sholay Location", "Vulture Reserve"],
    ...
    "timings": "9:00 AM - 5:00 PM",
    "bestTime": "September to March",
    "tags": ["Sholay", "Vulture", "Rock Climbing", "Adventure"],
    "isFeatured": True
  }
])
...
destinations.extend([
  # --- SHIVAMOGGA ---
  {
    ...
    "region": "Malnad",
    "category": "Nature",
    "subCategories": ["Untiered Waterfall", "Sharavathi River", "Raja Roarer Rocket Rani"],
    ...
    "bestTime": "July to October",
    "tags": ["Waterfall", "Jog Falls", "Sharavathi", "Nature", "Iconic"],
    "isFeatured": True
  },
  {
    ...
    "region": "Malnad",
    "category": "Nature",
    "subCategories": ["Cherrapunji of the South", "King Cobra Reserve", "Sunset"],
    ...
    "tags": ["Rainforest", "Sunset", "King Cobra", "Western Ghats"]
  },
  ...
  # --- TUMAKURU ---
  {
    ...
    "region": "Central Karnataka",
    "category": "Hills",
    "subCategories": ["Sacred Hills", "Yoga Narasimha", "Panoramic Views"],
    ...
    "timings": "7:00 AM - 6:00 PM",
    "bestTime": "October to March",
    "tags": ["Hills", "Narasimha", "Spiritual", "Viewpoint"]
  },
  ...
  # --- UDUPI ---
  {
    ...
    "region": "Coastal Karnataka",
    "category": "Spiritual",
    "subCategories": ["Madhvacharya", "Kanakana Kindi", "Ashta Mathas"],
    ...
    "bestTime": "All Year Round",
    "tags": ["Krishna", "Udupi", "Ashta Mathas", "Spiritual", "Prasada"],
    "isFeatured": True
  },
  {
    "id": "st-mary-island",
    ...
    "region": "Coastal Karnataka",
    "category": "Coast",
    "subCategories": ["Geological Monument", "Basalt Pillars", "Ferry Ride"],
    ...
    "bestTime": "October to May",
    "tags": ["Island", "Basalt", "Geological", "Beach"],
    "isFeatured": True
  },
  ...
  # --- UTTARA KANNADA ---
  {
    ...
    "region": "Coastal Karnataka",
    "category": "Coast",
    "subCategories": ["Om Shaped Shore", "Atmalinga", "Beach Trek"],
    ...
    "tags": ["Gokarna", "Om Beach", "Atmalinga", "Coast"],
    "isFeatured": True
  },
  {
    ...
    "region": "Coastal Karnataka",
    "category": "Spiritual",
    "subCategories": ["123ft Shiva Statue", "20-Storey Gopuram", "Peninsula Beach"],
    ...
    "bestTime": "October to March",
    "tags": ["Murudeshwara", "Shiva Statue", "Gopuram", "Beach"],
    "isFeatured": True
  },
  {
    ...
    "region": "Coastal Karnataka",
    "category": "Adventure",
    "subCategories": ["River Rafting", "Hornbill Sanctuary", "Dense Jungle"],
    ...
    "bestTime": "October to May",
    "tags": ["Rafting", "Dandeli", "Kali River", "Adventure"],
    "isFeatured": True
  },
  ...
  # --- VIJAYAPURA ---
  {
    ...
    "region": "North Karnataka",
    "category": "Heritage",
    "subCategories": ["Acoustic Wonder", "Second Largest Dome", "Adil Shahi"],
    ...
    "timings": "6:00 AM - 6:00 PM",
    "bestTime": "October to March",
    "tags": ["Gol Gumbaz", "Whispering Gallery", "Adil Shahi", "Dome"],
    "isFeatured": True
  },
  ...
  # --- YADGIR ---
  {
    ...
    "region": "Kalyana Karnataka",
    "category": "Heritage",
    "subCategories": ["Triple Walled", "Medieval Bastion", "Yadava Dynasty"],
  ...
  # --- VIJAYANAGARA ---
  {
    ...
    "region": "North Karnataka",
    "category": "Heritage",
    "subCategories": ["UNESCO World Heritage", "Stone Chariot", "Musical Pillars"],
    ...
    "timings": "8:30 AM - 5:30 PM",
    "bestTime": "October to March",
    "tags": ["UNESCO", "Stone Chariot", "Hampi", "Musical Pillars", "Iconic"],
    "isFeatured": True
  },
  {
    ...
    "region": "North Karnataka",
    "category": "Spiritual",
    "subCategories": ["Unbroken Worship Since 7th Century", "160ft Gopuram", "Pinhole Camera"],
    ...
    "bestTime": "October to March",
    "tags": ["Virupaksha", "Hampi", "Gopuram", "Spiritual"],
    "isFeatured": True
  },
  {
    "id": "tungabhadra-dam",
    ...
    "region": "North Karnataka",
    "category": "Nature",
    "subCategories": ["Reservoir", "Musical Fountain", "Sunset Promenade"],
    ...
    "tags": ["Dam", "Tungabhadra", "Gardens"]
  }
])



header = "import { Destination } from './types';\n\n"
with open('src/data/destinations.ts', 'w', encoding='utf-8') as f:
    f.write(header)
    f.write('export const DESTINATIONS_DATA: Destination[] = ' + json.dumps(destinations, indent=2, ensure_ascii=False) + ';\n\n')
    f.write('export const getDestinationsByDistrict = (districtId: string): Destination[] => {\n')
    f.write('  return DESTINATIONS_DATA.filter(d => d.districtId.toLowerCase() === districtId.toLowerCase());\n')
    f.write('};\n\n')
    f.write('export const getDestinationsByCategory = (category: string): Destination[] => {\n')
    f.write('  return DESTINATIONS_DATA.filter(d => d.category.toLowerCase() === category.toLowerCase());\n')
    f.write('};\n\n')
    f.write('export const getFeaturedDestinations = (): Destination[] => {\n')
    f.write('  return DESTINATIONS_DATA.filter(d => d.isFeatured);\n')
    f.write('};\n')

print(f'Destinations dataset built successfully with {len(destinations)} authentic attractions.')
